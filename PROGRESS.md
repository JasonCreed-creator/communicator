...
- **(2026-09-25 저녁) 묶음 진행**: ① ~~Phase 4.5 PR → 머지 → 실DB setup~~ → 완료(`480fb46` · 운영 확인) · 운영에서 항목 고치기·지우기 1회(사용자)
  ② Phase 6 Slack 알림 → PR·머지(진행 중) · 웹훅 주소를 받으면 실발송 1회('테스트 보내기') ③ Phase 4.7 협력사 견적서 불러오기(실서식 샘플은 사용자 — 받으면 보정)
  ④ 실사용 1회(발주처 링크 → `/c` 수정요청·승인 → `06_발주처공유` 사본) ⑤ `/privacy` 페이지 ⑥ 그 뒤 보안(입구 폐기·로그인) · 요금제 · 토큰 Revoke(사용자)
