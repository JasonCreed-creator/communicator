# CLAUDE.md — MICE 커뮤니케이터 구현 지침 v2.9.1 (Claude Code용)

> 레포 루트에 이 파일을 두고, `docs/mice-communicator-설계서-v2.10.md`를 함께 배치할 것(기존 설계서 파일은 버전 무관 전부 대체·삭제). `docs/mice-communicator-디자인지시서-v1.md`도 함께 배치(Phase 3.9 정본).
