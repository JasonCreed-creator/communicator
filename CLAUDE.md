...
> 레포 루트에 이 파일을 두고, `docs/mice-communicator-설계서-v2.13.md`를 함께 배치할 것(기존 설계서 파일은 버전 무관 전부 대체·삭제). `docs/mice-communicator-디자인지시서-v1.md`도 함께 배치(Phase 3.9 정본).
...
- **Phase 6.1 — Slack 봇 전환 + 의뢰 확인 버튼** (사용자 결정 2026-09-25 밤 3건 + 2026-09-26 "DM 지양 — 채널에서 멘션" · "프로젝트 = 채널의 스레드 하나", 설계서 v2.12 §9·§8.4)
