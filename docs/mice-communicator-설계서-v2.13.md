...
| (v2.2) 정산보드 S-10(마진 3분할·버킷 9+추가·항목 3단 추적·부가세 자동 분리·협력사 마스터) · (v2.11) 협력사 견적서 불러오기 — 엑셀 | (v2.2) 협력사 견적서 PDF·사진 파싱(v2.11에서 엑셀 먼저)·발주서 발행·협력사 단가 누적 통계 → 견적 단가 DB화 연결 |
