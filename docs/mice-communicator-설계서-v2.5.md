...
- **S9 확장**: ② 프로그램 섹션에 세션별 시나리오 상세 펼침(있을 때만) · ③ 존운영에 가이드 존 섹션 반영 · **⑦ 비상 대응 섹션 신설**(가이드 비상 섹션 조립, 인쇄 포함, 섹션 진행률 집계에 포함).
